...
**Requirement 1.** Following the example of Colors Service, upgrade Cars Service to use the Cars database table. Upgrade all Cars Service methods to use EF Core.
